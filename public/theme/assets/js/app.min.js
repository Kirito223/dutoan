...
var LIBS = {
    plot: [
        "theme/libs/misc/flot/jquery.flot.min.js",
        "theme/libs/misc/flot/jquery.flot.pie.min.js",
        "theme/libs/misc/flot/jquery.flot.stack.min.js",
        "theme/libs/misc/flot/jquery.flot.resize.min.js",
        "theme/libs/misc/flot/jquery.flot.curvedLines.js",
        "theme/libs/misc/flot/jquery.flot.tooltip.min.js",
        "theme/libs/misc/flot/jquery.flot.categories.min.js"
    ],
    chart: [
        "theme/libs/misc/echarts/build/dist/echarts-all.js",
        "theme/libs/misc/echarts/build/dist/theme.js",
        "theme/libs/misc/echarts/build/dist/jquery.echarts.js"
    ],
    circleProgress: [
        "theme/libs/bower/jquery-circle-progress/dist/circle-progress.js"
    ],
    sparkline: ["theme/libs/misc/jquery.sparkline.min.js"],
    maxlength: [
        "theme/libs/bower/bootstrap-maxlength/src/bootstrap-maxlength.js"
    ],
    tagsinput: [
        "theme/libs/bower/bootstrap-tagsinput/dist/bootstrap-tagsinput.css",
        "theme/libs/bower/bootstrap-tagsinput/dist/bootstrap-tagsinput.min.js"
    ],
    TouchSpin: [
        "theme/libs/bower/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.css",
        "theme/libs/bower/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.js"
    ],
    selectpicker: [
        "theme/libs/bower/bootstrap-select/dist/css/bootstrap-select.min.css",
        "theme/libs/bower/bootstrap-select/dist/js/bootstrap-select.min.js"
    ],
    filestyle: [
        "theme/libs/bower/bootstrap-filestyle/src/bootstrap-filestyle.min.js"
    ],
    timepicker: [
        "theme/libs/bower/bootstrap-timepicker/js/bootstrap-timepicker.js"
    ],
    datetimepicker: [
        "theme/libs/bower/moment/moment.js",
        "theme/libs/bower/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css",
        "theme/libs/bower/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js"
    ],
    select2: [
        "theme/libs/bower/select2/dist/css/select2.min.css",
        "theme/libs/bower/select2/dist/js/select2.full.min.js"
    ],
    vectorMap: [
        "theme/libs/misc/jvectormap/jquery-jvectormap.css",
        "theme/libs/misc/jvectormap/jquery-jvectormap.min.js",
        "theme/libs/misc/jvectormap/maps/jquery-jvectormap-us-mill.js",
        "theme/libs/misc/jvectormap/maps/jquery-jvectormap-world-mill.js",
        "theme/libs/misc/jvectormap/maps/jquery-jvectormap-africa-mill.js"
    ],
    summernote: [
        "theme/libs/bower/summernote/dist/summernote.css",
        "theme/libs/bower/summernote/dist/summernote.min.js"
    ],
    DataTable: [
        "theme/libs/misc/datatables/datatables.min.css",
        "theme/libs/misc/datatables/datatables.min.js"
    ],
    fullCalendar: [
        "theme/libs/bower/moment/moment.js",
        "theme/libs/bower/fullcalendar/dist/fullcalendar.min.css",
        "theme/libs/bower/fullcalendar/dist/fullcalendar.min.js"
    ],
    dropzone: [
        "theme/libs/bower/dropzone/dist/min/dropzone.min.css",
        "theme/libs/bower/dropzone/dist/min/dropzone.min.js"
    ],
    counterUp: [
        "theme/libs/bower/waypoints/lib/jquery.waypoints.min.js",
        "theme/libs/bower/counterup/jquery.counterup.min.js"
    ],
    others: [
   
        "theme/libs/bower/lightbox2/dist/css/lightbox.min.css",
        "theme/libs/bower/lightbox2/dist/js/lightbox.min.js"
    ]
};
+(function() {
    "use strict";
            ...
            return (
                lists.each(function() {
                    ...
                    $.isPlainObject(options[0]) &&
                        ...
                        "" != self.data("plugin") &&
                            loader
                                .load(LIBS[self.data("plugin")])
                                .then(function() {
                                    self[self.attr("data-plugin")].apply(
                                        self,
                                        options
                                    );
                                });
            ...
            h = {
                ...
                listenForEvents: function() {
                    ...
                    a(b).on("load", function(b) {
                        ...
                        f.on("click", function(a) {
                            c.folded ? c.unFold() : c.fold(),
                                a.preventDefault();
                        }),
                        g.on("click", function(a) {
                            c.open ? c.pushOut() : c.pullIn(),
                                a.preventDefault();
                        }),
                        a(document).on(
                ...
                setTopbarLayout: function() {
                    return (
                        app.$body
                            .removeClass(
                                "menubar-left menubar-unfold menubar-fold"
                            )
                ...
                reduceAppMenu: function() {
                    ...
                    if (c.length > 5) {
                        var d = a(
                                '<li class="more-items-li has-submenu"></li>'
                            ),
                        ...
                        f.append([
                            ...
                            d
                                .append([f, e])
                                .insertAfter(b.find(">li:nth-child(5)"));
                    }
                ...
                fold: function() {
                    return (
                        c
                            .removeClass("menubar-unfold")
                            .addClass("menubar-fold"),
                ...
                unFold: function() {
                    return (
                        c
                            .removeClass("menubar-fold")
                            .addClass("menubar-unfold"),
                ...
                readjustScroll: function(b) {
                    if (!c.hasClass("menubar-top") && !this.folded) {
                        var e = d.height(),
                            f = a(
                                ".menubar-scroll, .menubar-scroll-inner, .slimScrollDiv"
                            );
                ...
                toggleMenuHeading: function() {
                    return (
                        c.hasClass("menubar-fold")
                            ? a(".app-menu > li:not(.menu-separator)").each(
                                  function(b, c) {
                ...
                app.$navbar,
                {
                    ...
                    toggleMenubarFold: function() {
                        if (a(this).is(":checked")) {
                            if (
                                ((app.settings.menubar.folded = !0),
                                c.hasClass("menubar-fold"))
                            )
                                return;
                            app.menubar.fold();
                        } else
                            (app.settings.menubar.folded = !1),
                                app.menubar.unFold();
                        app.saveSettings();
                    },
                    ...
                    getTemplate: function(a) {
                        var b =
                            '<div class="theme-choice radio radio-' +
                            a +
                            ' m-b-md">';
                        return (
                            (b +=
