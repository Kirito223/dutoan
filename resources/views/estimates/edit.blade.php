    ...
    <section class="col-md-12 col-xs-12">
        <section class="panel panel-default">
            <section class="panel-heading">
                <p class="panel-title">Sửa dự toán</p>
            </section>
                ...
                <section class="row">
                    <section class="col-md-6 col-xs-6">
                        <div class="form-group">
                            ...
                            <input id="idEdit" value="{{$id}}" class="hidden" />
                        </div>
                ...
                <section class=" row">
                    ...
                    <section class="col-md-12 col-xl-12">
                        <section class="toolbox">
                            <button id="btnSave" class="btn btn-primary btn-sm">Sửa dự toán</button>
...
<script type="module" src="{{asset('js/features/estimates/edit.js')}}"></script>
@endsection